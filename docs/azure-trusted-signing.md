...
- Every `.exe`, `.msi`, and `.zip` produced under `build/` is signed in place. The action handles hashing, timestamping, and certificate management by requesting a short-lived certificate from Azure Trusted Signing.
