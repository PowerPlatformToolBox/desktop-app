...
This document provides queries and steps to create meaningful dashboards for the Power Platform ToolBox desktop application in Sentry.io.
...
3. Name it "Power Platform ToolBox - Error Monitoring"
