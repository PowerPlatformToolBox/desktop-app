...
import type { DataverseConnection } from "../../../../src/common/types";

// electron and electron-store are mocked via tests/__mocks__/

/** Helper: create a minimal valid DataverseConnection object */
function makeConnection(overrides: Partial<DataverseConnection> = {}): DataverseConnection {
    return {
        id: "conn-1",
