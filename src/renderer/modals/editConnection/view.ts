...
<div class="modal-panel">
    ...
    <div class="modal-footer connection-modal-footer">
        <div class="connection-modal-footer-actions">
            ...
            <button id="copy-script-save-btn" class="fluent-button fluent-button-secondary" style="display: none;">Copy Script &amp; Update</button>
            <button id="confirm-connection-btn" class="fluent-button fluent-button-primary">Update</button>
        </div>
